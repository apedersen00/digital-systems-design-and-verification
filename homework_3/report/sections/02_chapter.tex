...
We now have an expression that is significantly easier to implement in hardware. To further improve performance the fraction can be pre-calculated and stored in a Look-Up Table (LUT).
